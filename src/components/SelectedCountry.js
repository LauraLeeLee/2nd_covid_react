      ...
      <div>
        ...
        <div key={selectedApiData.parameters.country}
            className="selected-data-div">
              ...
              <p> <span className="data-titles"> New Cases:</span> {(((typeof selectedApiData.response[0]) != "undefined") && (selectedApiData.response[0].deaths.total > 0)) ? selectedApiData.response[0].cases.new.toLocaleString() : 0 }</p>
              <p> <span className="data-titles"> Total Deaths:</span> {(((typeof selectedApiData.response[0]) != "undefined") && (selectedApiData.response[0].deaths.total > 0)) ? selectedApiData.response[0].deaths.total.toLocaleString() : 0 }</p>
